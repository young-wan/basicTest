 ...
 * @Author: Young
 * @Description:
 * @Date: Created at 9/1 0001 11:48
 */
...
public class JsSignUtil {
    ...
    public static Map<String, String> sign(String url) {
        try {
            accessToken = WeiXinUtil.getAccessToken(Constants.APPID, Constants.SECRET).getAccessToken();
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        System.out.println("7.accessToken="+accessToken);
    ...
    public static boolean checkSignature(String signature, String timestamp, String nonce) {
        ...
        return tmpStr != null ? (tmpStr.toLowerCase()).equals(signature.toLowerCase()) : false;
    }
